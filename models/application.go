...
type Application struct {
	BaseModel
	Code            string            `gorm:"unique;not null" json:"code"` // HS001
	...
	Attachments   []Attachment         `gorm:"foreignKey:ApplicationID" json:"attachments,omitempty"`
	Histories     []ApplicationHistory `gorm:"foreignKey:ApplicationID" json:"histories,omitempty"`
}
